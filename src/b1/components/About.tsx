...
export const About: React.FC = () => (
  <div id="aboutSectionB1" className="homeSection alt">
    <Container fixed>
      <Grid container spacing={3}>
        <Grid item md={4} xs={12}>
          <Box maxWidth="270px" m="0 auto" className="animated slideRight normal">
            <img src="/images/b1/phone-logo.png" alt="B1 Church App" />
          </Box>
        </Grid>
        <Grid item md={8} xs={12}>
          <div className="animated slideLeft normal">
            ...
            <p>Providing a simple and seamless way for your congregation to connect is a critical need in the modern church.  B1.church provides a way to do this at home, at church or wherever they may be, via their phone.</p>
