  ...
  <div id="hero">
    <Container fixed>
      <Box sx={{textAlign: "center"}}>
        ...
        <Button href="#register" variant="contained" size="large" disableElevation sx={{ "&:focus": { outline: "none", color: "white" }, fontSize: "20px", textTransform: "capitalize", marginBottom: "20px" }} className="animated pulse slow">Get Started Now</Button>
      </Box>
    </Container>
  </div>
)
