      ...
      <Container>
        <Row>
          <Col lg={9}>
            ...
            <p>Most projects depend on the CoreApis (Access, Attendance, Giving, Membership, and Reporting).  You can set each of these up manually but it's far more simple to follow the <a href="#">Docker Setup Instructions</a> to get these running instead.</p>
