      ...
      <Grid container spacing={3}>
        <Grid item md={6} xs={12}>
          <ul className="checkList">
            ...
            <li><b>Lessons.church</b> – High quality church curriculum for children, youth and adults.  Includes an Android TV app for making presentation in classrooms a breeze.</li>
