  ...
  <div className="homeSection">
    <Container fixed>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item md={4} xs={12}><img src="/images/home/solutions/chums.png" alt="CHUMS" /></Grid>
      </Grid>
      <Box sx={{ textAlign: "center" }}>
        <Button variant="contained" color="success" style={{ paddingTop: 15, paddingBottom: 15, paddingLeft: 25, paddingRight: 25 }} href="https://chums.org/">Improve Your Workflows</Button>
      </Box>
    </Container>
  </div>
)
