...
export const AboutLessons: React.FC = () => (
  <div className="homeSection alt">
    <Container fixed>
      <h2 style={{lineHeight: 1.2, marginTop: 0}}>Lessons.church - <span>Free Curriculum  for Children and Adults</span></h2>
      <Grid container spacing={3}>
        ...
        <Grid item md={4} xs={12}><img src="/images/home/solutions/lessons.png" alt="Lessons.church" /></Grid>
      </Grid>
      <Box sx={{textAlign: "center"}} mt={4}>
        <Button variant="contained" color="success" style={{ paddingTop: 15, paddingBottom: 15, paddingLeft: 25, paddingRight: 25 }} href="https://lessons.church/">Get Your Free Content</Button>
      </Box>
    </Container>
  </div>
)
