    ...
    <Container fixed>
      <Grid container spacing={3}>
        <Grid item md={9} xs={12}>
          <h2 style={{lineHeight: 1.2, marginTop: 0}}>B1.church - <span>Mobile App for Congregations.</span></h2>
        ...
        <Grid item md={3} xs={12} sx={{textAlign: "center"}}><img src="/images/home/solutions/b1.png" alt="StreamingLive" className="img-fluid" /></Grid>
      </Grid>
      <Box sx={{textAlign: "center"}} mt={3}>
        <Button variant="contained" color="success" style={{ paddingTop: 15, paddingBottom: 15, paddingLeft: 25, paddingRight: 25 }} href="https://b1.church/">Set up Your Church</Button>
      </Box>
    </Container>
  </div>
)
